	...
	<table class="table table-bordered">
		...
		foreach ($barang as $brg) :?>
			...
			<tr>
				...
				<td><img height="42" width="42" src="<?php echo base_url().'uploads/'.$brg->gambar_brg?>"></td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
      	...
      	<form action="<?php echo base_url().'admin/data_barang/tambah_aksi' ?>" method="post" 
           ...
           <option>Agama</option>
           <option>Perikanan dan Kelautan</option> 
           <option>Piskologi</option>    
           <option>Sosial, Politik & Hukum</option> 
           <option>Umum</option> 
            </select>
      		</div>
